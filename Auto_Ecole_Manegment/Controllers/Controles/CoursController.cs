...
namespace Auto_Ecole_Manegment.Controllers.Controles
{
    public class CoursController : Controller
    {
        ...
        public CoursController(Auto_Ecole_ManegmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Description")] Cours cours)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Description")] Cours cours)
        {
            if (id != cours.Id)
            {
                return NotFound();
